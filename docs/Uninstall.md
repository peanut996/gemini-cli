...
If you installed the CLI globally (e.g., `npm install -g @peanut996/gemini-cli`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @peanut996/gemini-cli
```
