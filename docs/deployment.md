...
- `@peanut996/gemini-cli-core`: The backend, handling logic and tool execution.
- `@peanut996/gemini-cli`: The user-facing frontend.
...
- **NPM publication:** For publishing to the NPM registry, the TypeScript source code in `@peanut996/gemini-cli-core` and `@peanut996/gemini-cli` is transpiled into standard JavaScript using the TypeScript Compiler (`tsc`). The resulting `dist/` directory is what gets published in the NPM package. This is a standard approach for TypeScript libraries.
