...
import { Config, GeminiClient } from '@peanut996/gemini-cli-core';
...
vi.mock('@peanut996/gemini-cli-core', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@peanut996/gemini-cli-core')>();
  return {
    ...actual,
  };
});
