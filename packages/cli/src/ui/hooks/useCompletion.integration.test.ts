...
import { Config, FileDiscoveryService } from '@peanut996/gemini-cli-core';
...
// Mock dependencies
vi.mock('fs/promises');
vi.mock('@peanut996/gemini-cli-core', async () => {
  const actual = await vi.importActual('@peanut996/gemini-cli-core');
  return {
    ...actual,
